...
<head>
  ...
  <meta name="keywords" content="onepage, resume, CV HTML template, personal Vcard, html resume, free resume template, free HTML template, free bootstrap template, personal portfolio, free html portfolio">
	...
	<title>Daniel Gerald Gabriel</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="copyright text-center">
              <p>&copy; Daniel Gerald Gabriel 2017. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript" src="//go.pub2srv.com/apu.php?zoneid=1183912"></script>
	<!-- Javascript files -->
	<script src="assets/js/jquery.js"></script>
	<script src="assets/js/dggmonetize.js"></script>
